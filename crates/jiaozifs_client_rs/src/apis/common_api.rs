...
pub async fn get_setup_state(
...
) -> Result<models::SetupState, Error<GetSetupStateError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/setup", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSetupStateError> =
...
pub async fn get_version(
    configuration: &configuration::Configuration,
) -> Result<models::VersionResult, Error<GetVersionError>> {
    let local_var_configuration = configuration;

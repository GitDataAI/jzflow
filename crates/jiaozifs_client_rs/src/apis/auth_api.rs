...
) -> Result<models::UserInfo, Error<GetUserInfoError>> {
...
) -> Result<models::AuthenticationToken, Error<LoginError>> {
    let local_var_configuration = configuration;
...
pub async fn refresh_token(
    configuration: &configuration::Configuration,
) -> Result<models::AuthenticationToken, Error<RefreshTokenError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RefreshTokenError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn register(
    configuration: &configuration::Configuration,
    user_register_info: Option<models::UserRegisterInfo>,
) -> Result<models::UserInfo, Error<RegisterError>> {
    let local_var_configuration = configuration;

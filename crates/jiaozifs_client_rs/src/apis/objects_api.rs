...
pub async fn get_object(configuration: &configuration::Configuration, owner: &str, repository: &str, ref_name: &str, path: &str, r#type: models::RefType, range: Option<&str>)-> Result<impl futures_core::Stream<Item = reqwest::Result<Bytes>>, Error<GetObjectError>> {
    let local_var_configuration = configuration;

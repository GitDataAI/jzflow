...
pub async fn create_branch(configuration: &configuration::Configuration, owner: &str, repository: &str, branch_creation: models::BranchCreation) -> Result<models::Branch, Error<CreateBranchError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/repos/{owner}/{repository}/branch", local_var_configuration.base_path, owner=crate::apis::urlencode(owner), repository=crate::apis::urlencode(repository));
...
pub async fn delete_branch(configuration: &configuration::Configuration, owner: &str, repository: &str, ref_name: &str) -> Result<(), Error<DeleteBranchError>> {
    let local_var_configuration = configuration;
...
pub async fn get_branch(configuration: &configuration::Configuration, owner: &str, repository: &str, ref_name: &str) -> Result<models::Branch, Error<GetBranchError>> {
    let local_var_configuration = configuration;
...
pub async fn list_branches(configuration: &configuration::Configuration, owner: &str, repository: &str, prefix: Option<&str>, after: Option<&str>, amount: Option<i32>) -> Result<models::BranchList, Error<ListBranchesError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/repos/{owner}/{repository}/branches", local_var_configuration.base_path, owner=crate::apis::urlencode(owner), repository=crate::apis::urlencode(repository));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());

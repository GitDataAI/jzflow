...
pub async fn commit_wip(
    configuration: &configuration::Configuration,
    owner: &str,
    repository: &str,
    ref_name: &str,
    msg: &str,
) -> Result<models::Wip, Error<CommitWipError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CommitWipError> =
...
pub async fn delete_wip(
    configuration: &configuration::Configuration,
    repository: &str,
    owner: &str,
    ref_name: &str,
) -> Result<(), Error<DeleteWipError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteWipError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_wip(
    ...
    owner: &str,
    ref_name: &str,
) -> Result<models::Wip, Error<GetWipError>> {
    let local_var_configuration = configuration;
...
pub async fn get_wip_changes(
    configuration: &configuration::Configuration,
    owner: &str,
    repository: &str,
    ref_name: &str,
    path: Option<&str>,
) -> Result<Vec<models::Change>, Error<GetWipChangesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetWipChangesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_wip(
    configuration: &configuration::Configuration,
    owner: &str,
    repository: &str,
) -> Result<Vec<models::Wip>, Error<ListWipError>> {
    let local_var_configuration = configuration;
...
pub async fn revert_wip_changes(
    configuration: &configuration::Configuration,
    repository: &str,
    owner: &str,
    ref_name: &str,
    path_prefix: Option<&str>,
) -> Result<(), Error<RevertWipChangesError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = path_prefix {
        local_var_req_builder =
            local_var_req_builder.query(&[("pathPrefix", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RevertWipChangesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_wip(
    configuration: &configuration::Configuration,
    repository: &str,
    owner: &str,
    ref_name: &str,
    update_wip: models::UpdateWip,
) -> Result<(), Error<UpdateWipError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateWipError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,

...
impl Commit {
    pub fn new(hash: String, repository_id: uuid::Uuid, author: models::Signature, committer: models::Signature, merge_tag: String, message: String, tree_hash: String, parent_hashes: Vec<String>, created_at: i64, updated_at: i64) -> Commit {
        Commit {
            hash,
            repository_id,

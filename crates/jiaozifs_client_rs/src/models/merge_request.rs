...
impl MergeRequest {
    pub fn new(id: uuid::Uuid, sequence: i32, target_branch: uuid::Uuid, source_branch: uuid::Uuid, source_repo_id: uuid::Uuid, target_repo_id: uuid::Uuid, title: String, merge_status: i32, author_id: uuid::Uuid, created_at: i64, updated_at: i64) -> MergeRequest {
        MergeRequest {
            id,
            sequence,
            target_branch,

...
impl MergeRequestFullState {
    pub fn new(id: uuid::Uuid, sequence: i32, target_branch: uuid::Uuid, source_branch: uuid::Uuid, source_repo_id: uuid::Uuid, target_repo_id: uuid::Uuid, title: String, merge_status: i32, author_id: uuid::Uuid, changes: Vec<models::ChangePair>, created_at: i64, updated_at: i64) -> MergeRequestFullState {
